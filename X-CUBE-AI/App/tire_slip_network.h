/**
  ...
  ******************************************************************************
  */
#ifndef AI_TIRE_SLIP_NETWORK_H
#define AI_TIRE_SLIP_NETWORK_H

#include "tire_slip_network_config.h"
...
#define AI_TIRE_SLIP_NETWORK_INPUTS_IN_ACTIVATIONS   (4)
#define AI_TIRE_SLIP_NETWORK_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_TIRE_SLIP_NETWORK_IN_NUM        (1)

AI_DEPRECATED
#define AI_TIRE_SLIP_NETWORK_IN \
  ai_tire_slip_network_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_TIRE_SLIP_NETWORK_IN_SIZE { \
  AI_TIRE_SLIP_NETWORK_IN_1_SIZE, \
}
#define AI_TIRE_SLIP_NETWORK_IN_SIZE_BYTES { \
...
AI_DEPRECATED
#define AI_TIRE_SLIP_NETWORK_OUT \
  ai_tire_slip_network_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_TIRE_SLIP_NETWORK_OUT_SIZE { \
  AI_TIRE_SLIP_NETWORK_OUT_1_SIZE, \
}
#define AI_TIRE_SLIP_NETWORK_OUT_SIZE_BYTES { \
  AI_TIRE_SLIP_NETWORK_OUT_1_SIZE_BYTES, \
}
#define AI_TIRE_SLIP_NETWORK_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_TIRE_SLIP_NETWORK_OUT_1_CHANNEL     (1)
#define AI_TIRE_SLIP_NETWORK_OUT_1_SIZE        (1)
#define AI_TIRE_SLIP_NETWORK_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_TIRE_SLIP_NETWORK_N_NODES (5)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup tire_slip_network
 ...
 * @ref ai_tire_slip_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_tire_slip_network_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_tire_slip_network_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_tire_slip_network_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_TIRE_SLIP_NETWORK_*
 * defines into file @ref tire_slip_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_tire_slip_network_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_TIRE_SLIP_NETWORK_H */
