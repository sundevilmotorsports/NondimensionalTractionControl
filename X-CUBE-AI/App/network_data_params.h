...
#define AI_NETWORK_DATA_ACTIVATIONS_SIZES \
  { 284, }
#define AI_NETWORK_DATA_ACTIVATIONS_SIZE     (284)
#define AI_NETWORK_DATA_ACTIVATIONS_COUNT    (1)
#define AI_NETWORK_DATA_ACTIVATION_1_SIZE    (284)



#define AI_NETWORK_DATA_WEIGHTS_SIZES \
  { 592, }
#define AI_NETWORK_DATA_WEIGHTS_SIZE         (592)
#define AI_NETWORK_DATA_WEIGHTS_COUNT        (1)
#define AI_NETWORK_DATA_WEIGHT_1_SIZE        (592)
