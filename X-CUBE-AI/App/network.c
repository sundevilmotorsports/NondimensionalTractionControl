...
#define AI_NETWORK_MODEL_SIGNATURE     "0x0c96d067e6a4b7f80d5da8c418a395c0"
...
#define AI_TOOLS_DATE_TIME   "2026-02-17T11:12:14-0700"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 8, 24, 1, 1), AI_STRIDE_INIT(4, 4, 32, 768, 768),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_input_layer0_output_array.data = AI_PTR(g_network_activations_map[0] + 16);
    serving_default_input_layer0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 16);
    gemm_0_output_array.data = AI_PTR(g_network_activations_map[0] + 48);
    gemm_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 48);
    nl_1_output_array.data = AI_PTR(g_network_activations_map[0] + 48);
    nl_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 48);
    ...
    nl_3_output_array.data = AI_PTR(g_network_activations_map[0] + 48);
    nl_3_output_array.data_start = AI_PTR(g_network_activations_map[0] + 48);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 2016);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 2016);
    gemm_4_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_4_weights_array.data = AI_PTR(g_network_weights_map[0] + 2064);
    gemm_4_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 2064);
    gemm_4_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_4_bias_array.data = AI_PTR(g_network_weights_map[0] + 2112);
    gemm_4_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 2112);
    return true;
  }
